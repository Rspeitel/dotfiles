...
autoload -U compinit "${XDG_CACHE_HOME:-$HOME/.cache}/zsh/"
...
# History plugin TODO
# bindkey ${key[Control-Up]} history-substring-search-up
# bindkey ${key[Control-Down]} history-substring-search-down
